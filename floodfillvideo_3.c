...
flag=1;
seed=cvPoint(g,h);
cvFloodFill(img,seed,color,cvScalarAll(50.0),cvScalarAll(10.0),&comp,CV_FLOODFILL_FIXED_RANGE,NULL);
printf("ab %d  %d\n",g,h);
}
if(flag==1)
{
...
//cvDrawContours(img,comp.contour,cvScalarAll(255),cvScalarAll(0),-1,1,8,cvPoint(0,0));
