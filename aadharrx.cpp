    ...
    {   int radius=img2.cols/3;
        ...
        if( (char)c == 'w' || (char)c == ' ' || count==0 )
        {
            if(count==0)
            {
	            ...
	            cvLine(mask,cvPoint(radius/6,3*radius/2-radius),cvPoint(radius/6,3*radius/2*3/5),CV_RGB(255,255,255),20);
	            cvLine(mask,cvPoint(3*radius-radius/6,3*radius/2-radius),cvPoint(3*radius-radius/6,3*radius/2*3/5),CV_RGB(255,255,255),20);
	            markerMask2=mask;
