...
*/
		...
		int radius=60;
		cvZero(mask);
		cvLine(mask,cvPoint(3*radius/2,3*radius/2-radius/3),cvPoint(3*radius/2,3*radius/2+2*radius/3),CV_RGB(255,255,255),13);
		cvLine(mask,cvPoint(radius/6,3*radius/2-radius),cvPoint(radius/6,3*radius/2*5/3),CV_RGB(255,255,255),20);
		cvLine(mask,cvPoint(3*radius-radius/6,3*radius/2-radius),cvPoint(3*radius-radius/6,3*radius/2*5/3),CV_RGB(255,255,255),20);
...
//                continue;
           ...
           // imshow( "watershed", markers );
			...
			cvSaveImage("images/tmptest8.jpg",moved);            
